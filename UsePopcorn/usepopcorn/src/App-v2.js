...
export default function App() {
    ...
    function () {
      ...
      async function fetchMovie() {
        try {
          ...
          const errorMessage = err?.message || "Movie not found";
  ...
  return (
    <>
      ...
      <Main>
        {/* <Box element={<MovieList movies={movies} />} /> Implicit Element
        <Box
          element={
            <>
...
function MovieDetails({ selectedId, onCloseMovie, onWatchedMovie, watched }) {
  ...
  useEffect(
    function () {
      ...
      // Cleanup function: Is a function that returned when the component unmount
      return function () {
